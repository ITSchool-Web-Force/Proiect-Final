...
export default function Description() {
    return <>
        <p className={style.description_text}>We are committed to offering only the finest floral arrangements and gifts, backed by service that is friendly and prompt. 
