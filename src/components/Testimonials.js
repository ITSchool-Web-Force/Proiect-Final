      ...
      <div className="container-testimonials max-w-[1240px]" id="testimonials">
        ...
        <div className="grid gap-12 text-center md:grid-cols-2">
          ...
          <div className="mb-0">
            ...
            <p className="my-4 text-xl text-neutral-500 dark:text-neutral-300">
              &apos;It&apos;s a pleasure having Octavian as a colleague at IT
              School, he&apos;s so passionate about web development, eager to
              learn new things, putting effort and discipline in studying every
              day. This perseverence and curiosity for web development and the
              latest technologies will take him very far in this field. Any
              employer would be happy to have you in their team, Octavian!&apos;
            </p>
