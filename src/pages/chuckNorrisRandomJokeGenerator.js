...
//import data
import { chuckNorrisRandomJokes } from "../data/projectPages.js";
import Link from "next/link";

const chuckNorrisRandomJokeGenerator = () => {
  return (
    <div className="w-full">
      {chuckNorrisRandomJokes.map((item, index) => {
...
export default chuckNorrisRandomJokeGenerator;
