...
//import data
import { moviesTvShowsSite } from "../data/projectPages.js";
import Link from "next/link";

const cinethrill = () => {
  return (
    <div className="w-full">
      {moviesTvShowsSite.map((item, index) => {
          ...
          <div key={index}>
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
              <div className="col-span-4">
                ...
                <form
                  className="inline"
                  action="https://github.com/Octavian-Busuioc/Cinethrill"
                  method="get"
                  target="_blank"
                >
